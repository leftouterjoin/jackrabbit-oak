...
public class FileStoreLuceneIndexPocTest extends FileStoreNoIndexPerfPocTest {
	@Override
	...
	protected Logger getLogger() {
		return  LoggerFactory.getLogger(FileStoreLuceneIndexPocTest.class);
	}
	...
	@Test
	@TestSpec(
			objective = { "FileStore,LuceneIndexの性能測定" },
			confirmatins = {
