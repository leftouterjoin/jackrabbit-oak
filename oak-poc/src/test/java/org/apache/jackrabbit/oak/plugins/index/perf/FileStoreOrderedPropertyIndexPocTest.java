...
public class FileStoreOrderedPropertyIndexPocTest extends
	...
	protected Logger getLogger() {
		return  LoggerFactory.getLogger(FileStoreOrderedPropertyIndexPocTest.class);
	}
	...
	@Test
	@TestSpec(
			objective = { "FileStore,OrderedIndexの性能測定" },
			confirmatins = {
