...
public class MongoPropertyIndexPerfPocTest extends MongoNoIndexPerfPocTest {
	@Override
	...
	protected Logger getLogger() {
		return  LoggerFactory.getLogger(MongoPropertyIndexPerfPocTest.class);
	}
	...
	@Test
	@TestSpec(
			objective = { "MongoDocumentStore,PropertyIndexの性能測定" },
			confirmatins = {
